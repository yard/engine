Object.assign(pc, function () {
    ...
    Object.assign(ElementComponentSystem.prototype, {
        ...
        initializeComponentData: function (component, data, properties) {
            ...
            var result = component._findScreen();
                ...
                if (mask) {
                    if (nineSliced) {
                        if (!this.defaultScreenSpaceImageMask9SlicedMaterial) {
                            ...
                            this.defaultScreenSpaceImageMask9SlicedMaterial.alphaTest = 1 / 255.0;
                        ...
                        if (!this.defaultScreenSpaceImageMask9TiledMaterial) {
                            ...
                            this.defaultScreenSpaceImageMask9TiledMaterial.alphaTest = 1 / 255.0;
                        ...
                        if (!this.defaultScreenSpaceImageMaskMaterial) {
                            ...
                            this.defaultScreenSpaceImageMaskMaterial.alphaTest = 1 / 255.0;
                ...
                if (mask) {
                    if (nineSliced) {
                        if (!this.defaultImage9SlicedMaskMaterial) {
                            ...
                            this.defaultImage9SlicedMaskMaterial.alphaTest = 1 / 255.0;
                        ...
                        if (!this.defaultImage9TiledMaskMaterial) {
                            ...
                            this.defaultImage9TiledMaskMaterial.alphaTest = 1 / 255.0;
                        ...
                        if (!this.defaultImageMaskMaterial) {
                            ...
                            this.defaultImageMaskMaterial.alphaTest = 1 / 255.0;
